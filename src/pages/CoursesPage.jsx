        ...
        <div className="mt-6 pt-5 border-t border-gray-100">
          {enrolled ? (
            ...
            <div className="space-y-3">
              ...
              {/* EasyPaisa button */}
              <a href="https://wa.me/923172876305?text=I%20want%20to%20enroll%20in%20the%20course.%20Sending%20EasyPaisa%20payment%20screenshot."
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                ...
                {[
                  ...
                  <div key={i} className="flex items-start gap-2.5 text-sm text-gray-600 mb-2 last:mb-0">
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          {courses.map(c => (
            <button key={c.slug} onClick={() => setActiveSlug(c.slug)}
              className={`flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all border cursor-pointer ${activeSlug === c.slug
